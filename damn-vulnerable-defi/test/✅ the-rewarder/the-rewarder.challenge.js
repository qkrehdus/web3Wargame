...
describe('[Challenge] The rewarder', function () {
    ...
    it('Execution', async function () {
        ...
        const POC = await ethers.getContractFactory("Reward_POC");
        const poc = await POC.connect(player).deploy(flashLoanPool.address, rewarderPool.address, liquidityToken.address, rewardToken.address);
