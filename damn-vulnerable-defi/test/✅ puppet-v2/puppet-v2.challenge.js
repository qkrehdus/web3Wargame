...
describe('[Challenge] Puppet v2', function () {
    ...
    it('Execution', async function () {
        ...
        const poc = await (await ethers.getContractFactory("Puppetv2_POC")).connect(player).deploy(
            lendingPool.address,
            uniswapRouter.address,
            token.address,
            weth.address
        ...
        await weth.connect(player).transfer(poc.address, await weth.balanceOf(player.address));
