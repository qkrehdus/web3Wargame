...
describe('[Challenge] Free Rider', function () {
    ...
    it('Execution', async function () {
        ...
        const poc = await (await ethers.getContractFactory("Free_POC")).connect(player).deploy(
            marketplace.address,
            nft.address,
            uniswapPair.address,
            weth.address,
        ...
        await poc.connect(player).exploit({ value: 1n * 10n ** 16n });
    });
